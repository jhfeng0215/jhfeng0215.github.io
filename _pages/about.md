...
- I have published papers with total <a href='https://scholar.google.com/citations?hl=zh-CN&user=_uv2K98AAAAJ'>google scholar citations <strong><span id='total_cit'>10+</span></strong></a>.cc at top Information Systems conferences, such as ICIS and PACIS, and in renowned journals. My work has been accepted by ACM Transactions on Knowledge Discovery from Data (TKDD, CCF-B), IEEE Transactions on Intelligent Transportation Systems (IEEE ITS, CCF-B), IEEE Transactions on Engineering Management (IEEE TEM), and Expert Systems with Applications (ESWA, CCF-B).
